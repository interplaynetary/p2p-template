...
const Login = ({user, host, mode, setMode}: any) => {
  ...
  const checkAccount = async () => {
    const code = await new Promise<any>(res => {
    ...
    if (!account || (account as any).pub !== user.is.pub) {
    ...
    sessionStorage.setItem("name", (account as any).name)
  }
